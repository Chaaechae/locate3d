    ...
    train=dict(
        ...
        datasets=[
            ...
            dict(
                ...
                crop_w=crop_w,
                patch_size=patch_size,
                data_root="/group-volume/3Ddataset/data/hk_3d_maps_N",
            ...
            dict(
                ...
                data_root="/group-volume/3Ddataset/data/nuscenes",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "val", "test"],
                data_root="/group-volume/3Ddataset/data/semantic_kitti",
                transform=outdoor_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train"],
                data_root="/group-volume/3Ddataset/data/cap3d",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "val", "test"],
                data_root="/group-volume/3Ddataset/data/graspnet",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train"],
                data_root="/group-volume/3Ddataset/data/scanobjectnn_raw",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["Training", "Validation"],
                data_root="/group-volume/3Ddataset/data/arkitscenes",
            ...
            dict(
                ...
                data_root="/group-volume/3Ddataset/data/scannetpp",
                transform=indoor_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                data_root="/group-volume/3Ddataset/data/s3dis",
                transform=indoor_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "val"],
                data_root="/group-volume/3Ddataset/data/hm3d_fix",
                transform=indoor_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "test"],
                data_root="/group-volume/3Ddataset/data/re10k_align",
                transform=indoor_transform,
                test_mode=False,
                loop=1,
            ),
